...
each Tutamen secret. Figure XX shows the core storage server data
structures. In addition to storing data, each storage server is also
responsible for verifying the access control tokens provided by the
each client accessing the server.
