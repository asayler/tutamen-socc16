...
proposed over the previous five years. In particular, Tutamen focuses
on two key secret storage features absent form other systems -- the
ability to support contextual and out-of-band (OOB) authentication
mechanisms and the avoidance of any single-point-of-trust
requirements.
